...
/*#################################################  BUAT PDF DENGAN ITEXT PDF  ##################################################*/
            ...
            String FILE = "C:/Users/Maulana/Downloads/kasir-pjl-master/bill_"+id_pesanan+".pdf";    
...
/*#################################################  BUAT ISI BILL PDF DENGAN ITEXT PDF  ##################################################*/    
    private static void addContent(Document document, String id_pesanan, String bayar, String kembali) throws DocumentException {
      ...
      preface.add(new Paragraph("CASHIER", catFont));
      addEmptyLine(preface, 1);
      preface.add(new Paragraph("Jalan Informatika",smallBold));
      ...
      try {
            ...
            while (rs.next()){
                ...
                if(i==0){
                    preface.add(new Paragraph("ID Pemesanan: "+rs.getInt(1),normalFont));
                    addEmptyLine(preface, 1);
                    preface.add(new Paragraph("Meja Pemesanan: "+rs.getString(2),normalFont));
                    addEmptyLine(preface, 1);
                    preface.add(new Paragraph("Tanggal Pemesanan: "+rs.getString(3),normalFont));
                    addEmptyLine(preface, 3);
                    preface.add(new Paragraph("Rincian Pesananan:",smallBold));
                }
                addEmptyLine(preface, 1);
                preface.add(new Paragraph(rs.getString(4)+"\t\t@"+rs.getString(6)+"\t\t="+rs.getString(5),normalFont));
            ...
            addEmptyLine(preface, 1);
            preface.add(new Paragraph("Bayar: Rp."+bayar,smallBold));
            addEmptyLine(preface, 2);
            preface.add(new Paragraph("Kembali: Rp."+kembali,smallBold));
                
            addEmptyLine(preface, 3);
            preface.add(new Paragraph("Terimakasaih",smallBold));
